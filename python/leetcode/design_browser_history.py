...
homepage and you can visit another url, get back in the history 
number of steps or move forward in the history number of steps.

Implement the BrowserHistory class:

    BrowserHistory(string homepage) Initializes the object with 
    ...
    you will return only x steps. Return the current url after moving 
    ...
    you will forward only x steps. Return the current url after 
